...
import com.dasa.keepinventory.application.cqs.commands.estoque.RegistrarEntradaEstoqueCommand;
...
public class RegistrarEntradaEstoqueCommandHandler 
        implements CommandHandler<RegistrarEntradaEstoqueCommand, MovimentacaoEstoque> {
    ...
    public RegistrarEntradaEstoqueCommandHandler(
    ...
    @Override
    @Transactional
    public Result<MovimentacaoEstoque> handle(RegistrarEntradaEstoqueCommand command) {
        try {
